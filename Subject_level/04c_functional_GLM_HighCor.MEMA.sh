...
rm ROIPC.HighCor_concatenated.1D
cat ROIPC.HighCor.1D ROIPC.HighCor.1D ROIPC.HighCor.1D > ROIPC.HighCor_concatenated.1D
...
3dDeconvolve -overwrite -input ${SUBJ}.magnitude.pb03_volreg_detrended_masked_scaled_mean.nii.gz ${SUBJ}.odr_substracted_scaled_mean.nii.gz ${SUBJ}.Lsqrs.magnitude_phdenoised_scaled_mean.nii.gz						\
	...
	-ortvec ROIPC.HighCor_concatenated.1D PC.HighCor		                               								\
	...
	-x1D ${SUBJ}.GLM_4MEMA.HighCor.X.xmat.1D -xjpeg ${SUBJ}.GLM_4MEMA.HighCor.X.jpg -x1D_uncensored ${SUBJ}.GLM_4MEMA.HighCor.X.nocensor.xmat.1D				\
	-fitts ${SUBJ}.GLM_4MEMA.HighCor.fitts.nii.gz -errts ${SUBJ}.GLM_4MEMA.HighCor.errts.nii.gz -bucket ${SUBJ}.GLM_4MEMA.stats.nii.gz


3dREMLfit -overwrite -matrix ${SUBJ}.GLM_4MEMA.HighCor.X.xmat.1D \
	...
	-fout -tout -Rbuck ${SUBJ}.GLM_4MEMA_REML.HighCor.stats.nii.gz -Rvar ${SUBJ}.GLM_4MEMA_REMLvar.HighCor.stats.nii.gz \
	-Rerrts ${SUBJ}.GLM_4MEMA_REML.HighCor.errts.nii.gz -Rfitts ${SUBJ}.GLM_4MEMA_REML.HighCor.fitts.nii.gz -verb
